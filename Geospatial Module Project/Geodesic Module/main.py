...
def geodisc_formula():
    ...
    location_point_x2 = float(input("Enter x point: ")) # sample (48.8567)
    location_point_y2 = float(input("Enter y point: ")) # sample (2.3508)
    ...
    method = str(input("Enter 'geodisc' or 'great circle' for distance calculation: "))
    ...
    if method == 'geodisc':
        ...
        print('\n')
        print("You didn't select either method. Please try again.")
        print('\n')
